...
Boat.create(boat_model: "le martinique", description: "un super voilier", picture: "my picture", licence: "permis haute mer", person_number: 4, price: 5000, localisation: "nice" )
